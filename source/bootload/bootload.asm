...
; floppy for KERNEL.BIN (the RGJREX kernel), loads it and executes it.
...
OEMLabel		db "RGJXBOOT"	; Disk label
...
VolumeLabel		db "RGJREX     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; RGJREX kernel filename
