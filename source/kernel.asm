...
; ==================================================================
	...
	%DEFINE RGJREX_VER '1.0'	; OS version number
	%DEFINE RGJREX_API_VER 0	; API version for programs to check
...
; use a RGJREX system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as RGJREX and its programs
...
option_screen:
	...
	os_init_msg		db '                            Welcome to RGJREX O.S.    ', 0
	os_version_msg		db 'Members: Rehan, Somnath, Susmita, Shrabasti, Sadhitra', 0

	dialog_string_1		db '        ---  MINOR PROJECT --- ', 0
	dialog_string_2		db '    16-Bit O.S. with BASIC Interpreter', 0
	dialog_string_3		db 'OK - Program menu, Cancel - Command Line', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute RGJREX kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of RGJREX, and', 0
